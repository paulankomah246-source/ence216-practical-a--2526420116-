...
Calling setState() flags the element as "dirty" and schedules a frame rebuild, forcing Flutter to redraw the user interface with whatever current values exist in the state data, regardless of where that data was modified.
Add main.dart with challenges⁠
